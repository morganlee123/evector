...
# The purpose of this file is to perform a speaker verification for MSP podcast using a pretrained ECAPA with MSP Train set
...
#
# NOTE: Here is the syntax to run: python ecapa_speaker_verif_MSP_pretrainedMSP.py <val/test1/test2> <dataset_root_path>
# example: python ecapa_speaker_verif_MSP_pretrainedMSP.py val /research/iprobe/datastore/datasets/speech/utd-msppodcast_v1.8/


def get_model():
    model_save_path = Path('/research/iprobe-sandle20/Playground/evector/encoder/saved_models/baseline_ecapa_backups/baseline_ecapa_bak_007500.pt') # NOTE: Add your own path here to your saved model
    module_name = 'ecapa_tdnn' # ECAPA-TDNN Architecture

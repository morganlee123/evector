...
# Purpose: Perform analysis on the computed results from the finetuned ECAPA model

# SYNTAX. Choose your set between val, test1, or test2
# e.g., python ft_ecapa_results_analysis.py [val/test1/test2] > [val/test1/test2].txt
...
test_results = pd.read_csv('../ExperimentData/125epoch/'+sys.argv[1]+'_results.csv', # NOTE: Using 125 epoch model
                            header=0, 

...
#
# Usage: python ecapa_ser_experiment.py [test1/test2] <dataset root>
# Example: python ecapa_ser_experiment.py test2 /research/iprobe/datastore/datasets/speech/utd-msppodcast_v1.8/
# 
...
with open('../../ExperimentData/125epoch/val_speaker_embeddings.pickle', 'rb') as handle:
    embeds = pickle.load(handle)

with open('../../ExperimentData/125epoch/'+test_set+'_speaker_embeddings.pickle', 'rb') as handle:

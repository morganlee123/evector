...
classifier = EncoderClassifier.from_hparams(source="/research/iprobe-sandle20/Playground/evector/baseline_experiment/finetuned_ecapavox/") # pretrainedvox1+2 w/ ft msp model

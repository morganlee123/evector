...
# COMMAND SYNTAX python ecapa_results_analysis.py <val/test1/test2> <msp/vox>
# Works for both analyzing MSP pretrained and VOXCeleb pretrained depending on the input parameter mentioned in the prev line

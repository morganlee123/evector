...
# e.g., python det_curves.py [val/test1/test2]
...
ax = plt.gca()
d1 = metrics.DetCurveDisplay.from_predictions(ground1_truth, total1_scores, ax=ax, name='E-Vector w/ 10 factors')
d2 = metrics.DetCurveDisplay.from_predictions(ground2_truth, total2_scores, ax=ax, name='E-Vector w/ 5 factors')
d3 = metrics.DetCurveDisplay.from_predictions(ground3_truth, total3_scores, ax=ax, name='E-Vector w/ 20 factors')
